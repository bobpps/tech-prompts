...
detects the platform once and follows only that branch; it writes the files, runs seventeen offline
...
~/.local/lib/claude-muse/launcher.test.cjs   ten offline tests
