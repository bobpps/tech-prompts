...
detects the platform once and follows only that branch; it writes the files, runs sixteen offline
...
~/.local/lib/claude-muse/launcher.test.cjs   nine offline tests
