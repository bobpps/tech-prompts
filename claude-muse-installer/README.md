...
detects the platform once and follows only that branch; it writes the files, runs thirty-five offline
...
~/.local/lib/claude-muse/adapter.test.cjs    nineteen offline tests
