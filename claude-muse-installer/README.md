...
detects the platform once and follows only that branch; it writes the files, runs twenty-one offline
...
~/.local/lib/claude-muse/adapter.test.cjs    nine offline tests
