...
detects the platform once and follows only that branch; it writes the files, runs fifty-one offline
...
~/.local/lib/claude-muse/adapter.test.cjs    thirty-four offline tests
