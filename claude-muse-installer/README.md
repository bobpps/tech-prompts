...
detects the platform once and follows only that branch; it writes the files, runs thirty offline
...
~/.local/lib/claude-muse/adapter.test.cjs    fifteen offline tests
