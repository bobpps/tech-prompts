...
detects the platform once and follows only that branch; it writes the files, runs eighteen offline
...
~/.local/lib/claude-muse/launcher.test.cjs   eleven offline tests
~/.local/lib/claude-muse/adapter.test.cjs    seven offline tests
