...
detects the platform once and follows only that branch; it writes the files, runs forty-seven offline
...
~/.local/lib/claude-muse/adapter.test.cjs    thirty offline tests
